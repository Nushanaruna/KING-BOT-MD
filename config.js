...
module.exports = {
    ...
    OWN_NUMBER: process.env.OWNER_NUMBER === undefined ? '94741089734' : process.env.OWN_NUMBER,
    OWN_NAME: process.env.OWNER_NAME === undefined ? 'WHITE CRAZY' : process.env.OWN_NAME,
    BOT_NAME: process.env.BOT_NAME === undefined ? 'CRAZY BOT-ᎷᎠ' : process.env.BOT_NAME,
    ST_PKG: process.env.STICKER_PACKAGE === undefined ? '94741089734' : process.env.ST_PKG,
